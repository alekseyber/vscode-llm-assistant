...
4. Запиши план через write_file в указанный путь (он будет передан в задаче)
...
export class PlanModeManager {
  ...
  async generatePlan(
    ...
    const plannerTask = [
      ...
      '2. Изучи затронутые файлы в workspace через инструменты',
      '3. Создай план по структуре из system prompt',
      '4. Запиши план через write_file по указанному пути',
      '5. В ответе кратко сообщи что план создан',
    ].join('\n');
