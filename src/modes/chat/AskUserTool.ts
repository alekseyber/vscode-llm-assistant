...
// v0.8.21: stable — все AC пройдены
...
export function createAskUserTool(): ChatTool {
  return {
    ...
    description:
      ...
      'ВАЖНО: не повторяй уже заданные вопросы. Если в истории есть [ВОПРОС ЗАКРЫТ] с таким же вопросом — не переспрашивай. Новые вопросы по другой теме задавать можно.',
    parameters: {
      type: 'object',
      properties: {
