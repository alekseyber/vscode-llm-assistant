...
- FOCUS_ON_ARGUMENT: `promptTemplate` содержит «работай ТОЛЬКО с названной функцией/классом» — уважает аргумент команды (SC-7)
...
| 0.10.0 | 2026-08-19 | Директива FOCUS_ON_ARGUMENT: команды уважают аргумент (названную функцию/класс) |
