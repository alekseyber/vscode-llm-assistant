...
|--------|------|-----------|
| 0.13.0 | 2026-08-23 | Async-провайдер: LLM-запрос в `provideInlineCompletionItems`; фолбэк провайдера/модели; отключение `thinking` для deepseek-моделей (иначе reasoning съедал maxTokens и `content` был пустым) |
